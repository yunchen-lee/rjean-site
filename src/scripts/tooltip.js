...
class Tooltip {
    constructor(gridEl) {
        ...
        this.rowAnimationDirections = {
            subTitle: { in: { yPercent: -100 }, out: { yPercent: -100 } }, // In and out to/from the top
            title: { in: { yPercent: 100 }, out: { yPercent: 100 } }, // In and out to/from the bottom
    ...
    handleMouseMove = (e) => {
        ...
        if (!this.isTooltipVisible) {
            ...
            gsap.fromTo(
                this.tooltip, { scale: 0, opacity: 1, transformOrigin: '0% 100%' }, {...this.animationConfig.tooltip, scale: 1 }
            );
        ...
        this.scaleDownTimeout = setTimeout(() => {
            if (!this.hoverTarget) {
                ...
                this.updateTooltip({ subTitle: '', title: '' }, this.scaleDownTimeline, 'out');
                this.scaleDownTimeline.to(
                    this.tooltip, {...this.animationConfig.tooltip, scale: 0 },
    ...
    handleMouseEnter = (e) => {
        ...
        const subTitle = this.hoverTarget.dataset.subtitle;
        ...
        this.updateTooltip({ subTitle: subTitle, title: title }, updateTimeline, this.isTooltipVisible ? 'none' : 'in');
    };
    ...
    updateTextSlider(rowSelector, newValue, timeline, direction) {
        ...
        const animationDirection = this.rowAnimationDirections[rowField] || this.rowAnimationDirections['title'];
        ...
        if (direction === 'in') {
            ...
            const transitionOutDirection = {
                subTitle: { yPercent: 100 }, // Slide down for subTitle
                title: { yPercent: -100 }, // Slide up for title
